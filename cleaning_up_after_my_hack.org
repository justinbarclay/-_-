...
All right, after looking at everything I've written so far I don't like it. It's all very wet behind the ear code, and I think with a bit of forethough and a towel I can dry it up.
...
I've decided to take things a step farther: I'm using an [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Association-Lists.html][alist]] as a key-value store and taking advantage of the fact that when ~completing-read~ is passed an association list it takes the CAR of each list as the options for the function.
#+BEGIN_SRC emacs-lisp
...
*** DRY IT UP!
** Foot Notes
[fn:1] I think it's important to note that all operations happened based around point, cursor, this is why at the beginning of each loop we move point to the beginning of line.
